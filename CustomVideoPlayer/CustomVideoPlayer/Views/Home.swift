...
//                }
        if let url = URL(string: "https://customer-i6oni2kwo89vbrxk.cloudflarestream.com/c3a12c30f074637d2eb198f2abbbbbc8/manifest/video.m3u8") {
            return .init(url: url)
        }
...
//        .padding(.top, safeArea.top)
        .onAppear {
            ...
            /// Adding Observer to update seeker when is Playing
...
//            }
    ...
    func SeekerThumbnailView(_ videoSize: CGSize) -> some View {
        ...
        /// Moving Alogn side with Gesture
    ...
    func VideoSeekerView(_ videoSize: CGSize) -> some View {
        ...
        .overlay(alignment: .leading) {
            ...
            /// Showing Drag Knob Only When Drag
    ...
    func PlayBackControls() -> some View {
        HStack(spacing: 25) {
            ...
            /// Disabling Buttons
            /// Since we have to action's for it
            .disabled(true)
            .opacity(0.6)
            ...
            Button {
                ...
                /// Changing Icon Based on Video State
                /// Changing Icon When Video was Finished
                Image(systemName: isFinishedPlaying ? "arrow.counterclockwise" : (isPlaying ? "pause.fill" : "play.fill"))
                    .font(.title)
                    .foregroundStyle(.white)
                    .padding(15)
                    .background {
